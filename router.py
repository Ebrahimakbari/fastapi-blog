...
router.add_api_route('/user/email/', get_user_by_email_api, methods=['GET'], response_model=UserResponse)
...
router.add_api_route('/post/all', get_posts_api, methods=['GET'], response_model=list[PostResponse])
